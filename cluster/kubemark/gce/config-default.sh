...
TEST_CLUSTER_STORAGE_MEDIA_TYPE="--storage-media-type=application/vnd.kubernetes.protobuf"
...
USE_REAL_PROXIER=${USE_REAL_PROXIER:-false}  # for hollow-proxy
